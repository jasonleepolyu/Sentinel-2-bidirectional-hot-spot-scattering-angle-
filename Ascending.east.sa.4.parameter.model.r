############################################################################################################ 
### This code is used to calculate the 4-parameter model scattering angles on COVE ascending orbit eastern edges 
...
###  inclination 
 ...
 dLocalMeanSiderealTime <- (6.6974243242 + 0.0657098283 * dElapsedJulianDays + modeled_east_lt ) * 15 * rad;  ###    West_lt    hour + West_lon/15    hour + longitude/15
